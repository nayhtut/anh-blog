...
import com.anh.rss.ObjectFactory;
import com.anh.rss.TRss;
import com.anh.rss.TRssChannel;
import com.anh.rss.TRssItem;
...
public class RssService {
	...
	private List<Item> getItems(Source source) throws RssException{
		...
		try {
			JAXBContext jaxbContent = JAXBContext.newInstance(ObjectFactory.class);
